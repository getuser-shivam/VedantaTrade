...
// final Map<String, String> _passwords = {}; // TODO: Move to environment variables
...
// _passwords[adminUser.email] = _hashPassword('Admin@123456'); // TODO: Move to environment variables
...
// _passwords[mrUser.email] = _hashPassword('MR@123456'); // TODO: Move to environment variables
...
// _passwords[stockistUser.email] = _hashPassword('Stockist@123456'); // TODO: Move to environment variables
  }
...
// if (_passwords[email] != hashedPassword) return null; // TODO: Move to environment variables
  ...
  Future<UserEntity?> signUp(String email, String password, String firstName, String lastName, String phoneNumber) async {
    ...
    _users[email] = user;
// _passwords[email] = _hashPassword(password); // TODO: Move to environment variables
...
// print('Password reset token for $email: $resetToken'); // Removed for production
    }
  }
...
// final token = _generateToken().substring(0, 6).toUpperCase(); // TODO: Move to environment variables
// _mfaTokens[userId] = token; // TODO: Move to environment variables
...
// final isValid = storedToken != null && storedToken == token.toUpperCase(); // TODO: Move to environment variables
  ...
  Future<void> updatePassword(String userId, String newPassword) async {
    ...
    final user = _users.values.firstWhere((u) => u.id == userId);
// _passwords[user.email] = _hashPassword(newPassword); // TODO: Move to environment variables
...
// print('Email verification token for $email: $verificationToken'); // Removed for production
  }
...
// print('Phone verification code for $phoneNumber: $verificationCode'); // Removed for production
  }
...
// final token = _generateJwtToken(user); // TODO: Move to environment variables
// _jwtTokens[user.id] = token; // TODO: Move to environment variables
    return token;
  }
...
// .firstWhere((entry) => entry.value == token, // TODO: Move to environment variables
            orElse: () => MapEntry('', ''))
        .key;
...
// _jwtTokens.removeWhere((key, value) => value == token); // TODO: Move to environment variables
  }
...
// return password.length >= policy['minLength'] && // TODO: Move to environment variables
  ...
  @override
// Future<bool> isTokenValid(String token) async => true; // TODO: Move to environment variables
  
  @override
// Future<DateTime?> getTokenExpiry(String token) async => DateTime.now().add(const Duration(hours: 24)); // TODO: Move to environment variables
  
  @override
  Future<String> generateCrossDeviceToken(String userId) async => _generateToken();
  
  @override
// Future<bool> verifyCrossDeviceToken(String userId, String token) async => true; // TODO: Move to environment variables
