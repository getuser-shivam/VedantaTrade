...
// final _passwordCtrl = TextEditingController(); // TODO: Move to environment variables
  ...
  void initState() {
    super.initState();
// _isResetMode = widget.token != null; // TODO: Move to environment variables
  }
                            ...
                            children: [
                              if (!_isResetMode) ...[
                                ...
                                GlassmorphicTextField(
                                  ...
                                  obscureText: !_isPasswordVisible,
// validator: (val) => val != _passwordCtrl.text ? 'Passwords mismatch' : null, // TODO: Move to environment variables
