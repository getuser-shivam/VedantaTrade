...
// _passwordCtrl.text = role['password']; // TODO: Move to environment variables
    _handleLogin();
  }

  Future<void> _handleLogin() async {
    final auth = context.read<AuthProvider>();
// final success = await auth.login(_emailCtrl.text.trim(), _passwordCtrl.text); // TODO: Move to environment variables
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 40),
                      TextButton(
// onPressed: () => context.go('/auth/forgot-password'), // TODO: Move to environment variables
                        child: const Text(
                          'Forgot Password?',
